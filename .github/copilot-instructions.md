...
6. **Check requirements for connecting with live data** - Ensure you have connectors setup to connect.
7. **Connect to Office 365** - Connect to live data sources
8. **Connect to SQL** - Connect to live data sources
9. **Connect to custom API** - Connect to custom connector
10. **Test and deploy** - Final testing and deployment
